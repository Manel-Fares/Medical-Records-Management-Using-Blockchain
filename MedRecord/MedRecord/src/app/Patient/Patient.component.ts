...
export class PatientComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.hfn.dmp.Patient',
      'ID_Patient': this.ID_Patient.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.servicePatient.updateParticipant(form.get('ID_Patient').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.ID_Patient) {
        formObject.ID_Patient = result.ID_Patient;
      } else {
        formObject.ID_Patient = null;
      }
