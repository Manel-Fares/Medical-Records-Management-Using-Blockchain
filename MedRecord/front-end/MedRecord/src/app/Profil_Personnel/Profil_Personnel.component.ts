...
@Component({
  selector: 'app-profil_personnel',
  templateUrl: './Profil_Personnel.component.html',
  styleUrls: ['./Profil_Personnel.component.css'],
  providers: [Profil_PersonnelService]
})
export class Profil_PersonnelComponent implements OnInit {
  ...
  constructor(public serviceProfil_Personnel: Profil_PersonnelService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceProfil_Personnel.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.hfn.dmp.Profil_Personnel',
    ...
    return this.serviceProfil_Personnel.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceProfil_Personnel.updateAsset(form.get('ID').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceProfil_Personnel.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceProfil_Personnel.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
