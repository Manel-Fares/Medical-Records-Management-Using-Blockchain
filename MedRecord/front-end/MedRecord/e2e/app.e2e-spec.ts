...
describe('Starting tests for MedRecord', function() {
  ...
  it('navbar-brand should be MedRecord',() => {
    ...
    it('Profil_Personnel component should be loadable',() => {
      page.navigateTo('/Profil_Personnel');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Profil_Personnel');
      });
    });

    it('Profil_Personnel table should have 11 columns',() => {
      page.navigateTo('/Profil_Personnel');
    ...
    it('Personnel_Medical component should be loadable',() => {
      page.navigateTo('/Personnel_Medical');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Personnel_Medical');
      });
    });

    it('Personnel_Medical table should have 2 columns',() => {
      page.navigateTo('/Personnel_Medical');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Ajouter_Personnel_Medical component should be loadable',() => {
      page.navigateTo('/Ajouter_Personnel_Medical');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Ajouter_Personnel_Medical');
      });
    });
    ...
    it('Creer_Profil_Personnel component should be loadable',() => {
      page.navigateTo('/Creer_Profil_Personnel');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Creer_Profil_Personnel');
      });
    });
